defmodule LiscCypherWeb.UserAuthTest do
  use LiscCypherWeb.ConnCase, async: true

  alias LiscCypher.Accounts
  alias LiscCypherWeb.UserAuth
  import LiscCypher.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, LiscCypherWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      LiscCypherWeb.Endpoint.subscribe(live_socket_id)
