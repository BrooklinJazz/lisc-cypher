defmodule LiscCypher.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, LiscCypher.Repo)
  ...
  """
  def valid_password?(%LiscCypher.Accounts.User{hashed_password: hashed_password}, password)
